 ...
 * 作者: @NobyDa
 *
 * Surge模块地址: https://raw.githubusercontent.com/6ob/IOS14/main/IPA_install.sgmodule
 * 
 * 本地浏览器安装脚本: itms-services://?action=download-manifest&url=https://6ob/install
 *
		...
		<dict>
			...
			<array>
				<dict>
					...
					<key>url</key>
					<string>https://6ob/download${eva.url.match(/jsbox/)?"/jsbox":""}</string>
				</dict>
			</array>
			<key>metadata</key>
			<dict>
